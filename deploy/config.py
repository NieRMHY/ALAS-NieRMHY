...
# Modify by MHY, 本地无 goc 更新链，常量仅作占位指向自有仓库
GIT_OVER_CDN_REPOSITORY = 'https://github.com/NieRMHY/ALAS-NieRMHY.git'
GIT_OVER_CDN_FALLBACK_REPOSITORY = 'https://github.com/NieRMHY/ALAS-NieRMHY.git'
