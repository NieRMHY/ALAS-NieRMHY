...
class TestFarmingCombatConfig(unittest.TestCase):
    ...
    def test_old_config_gets_priority_without_changing_submarine_defaults(self):
        ...
        for task in TASKS:
            ...
            # Modify by MHY, 本仓库 EnemyScaleBalanceWeight 默认 S1_enemy_first（上游 default_mode）
            ...
            # Modify by MHY, 本仓库 Submarine_DistanceToBoss 默认 2_grid_to_boss（上游 use_open_ocean_support）
